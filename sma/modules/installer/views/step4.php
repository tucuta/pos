...
<div class="clearfix"></div>
        ...
        <p class="lead">Please enter the information to create owner account. Field with * are required.</p>
      ...
      <div class="well">
      <?php $attrib = array('class' => 'form-horizontal', 'id' => 'addSale_form'); echo form_open("module=installer&view=setup&step=4", $attrib); ?>
